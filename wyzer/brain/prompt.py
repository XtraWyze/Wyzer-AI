...
class SystemPromptBuilder:
    ...
    def build(self, world: WorldStateSnapshot, conversation: ConversationState) -> str:
        ...
        prompt = (
            ...
            "actions, silently call task_plan_create with outcome-focused steps before acting. "
            "You must create that plan before requesting multiple capability calls in one turn. "
            ...
            "before that step can be marked verified. On failure, use the evidence to retry a "
            ...
            "open. Prefer list_open_windows with a query for desktop-window status and use "
            "is_process_running when background-process status matters. For an immediate follow-up "
            ...
            "a web task and do not call browser_status or browser_start before every browser action. "
            ...
            "a visible target to click, use activate_visual_target directly. It uses Qwen vision first and "
